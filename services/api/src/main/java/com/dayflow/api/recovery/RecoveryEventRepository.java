...
public interface RecoveryEventRepository extends JpaRepository<RecoveryEvent, UUID> {
    ...
    List<RecoveryEvent> findAllByOrderByAppliedAtDesc(Pageable pageable);
    ...
    @Query("""
            ...
            where i.dayId in :dayIds
            order by e.appliedAt desc
            """)
    List<RecoveryEventItem> findItemsNewestFirst(@Param("dayIds") Collection<UUID> dayIds);
}
