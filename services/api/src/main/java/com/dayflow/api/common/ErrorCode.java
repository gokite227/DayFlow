...
public enum ErrorCode {
    ...
    INVALID_EVENT_CATEGORY(HttpStatus.BAD_REQUEST, "Event Category not found"),
    INVALID_EVENT_CATEGORY_COLOR(HttpStatus.BAD_REQUEST, "Invalid Event Category color"),
    DUPLICATE_EVENT_CATEGORY_NAME(HttpStatus.BAD_REQUEST, "Duplicate Event Category name"),
