...
import { recoveryActionBlockedReason, type MoveRange, type RecoveryDraft } from "./recovery-plan";
...
export function recommendationUsable(
  ...
  if (recoveryActionBlockedReason(recommendation.action, day, goal, range) !== null) return false;
